...
module.exports = function() {
    this.Given(/^I am on the homepages$/, function (callback) {
    ...
    this.Then(/^I should see "(.*)" as links$/, function (callback) {
/*var text;
   ...
   //     element(by.linkText("List of Organizations")).click();
    ...
    this.Then(/^I should see "([^"]*)" on page1234$/, function (callback) {
        // Write code here that turns the phrase above into concrete actions
        browser.waitForAngular();
        expect(element(by.linkText("Organization12s")).isPresent()).to.become(false);
        browser.waitForAngular();
